...
/// <summary>
/// Tests for <see cref="IterativePositionalNotationConverter"/>.
/// </summary>
public class IterativePositionalNotationConverterTests
{
    private IterativePositionalNotationConverter _converter;

    [SetUp]
    public void Setup()
    {
        _converter = new IterativePositionalNotationConverter();
    }
