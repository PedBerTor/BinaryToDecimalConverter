...
/// <summary>
/// Tests for <see cref="FunctionalDoublingConverter"/>.
/// </summary>
public class FunctionalDoublingConverterTests
{
    private FunctionalDoublingConverter _converter;

    [SetUp]
    public void Setup()
    {
        _converter = new FunctionalDoublingConverter();
    }
