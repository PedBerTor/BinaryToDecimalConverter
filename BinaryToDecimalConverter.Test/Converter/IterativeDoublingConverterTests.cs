...
/// <summary>
/// Tests for <see cref="IterativeDoublingConverter"/>.
/// </summary>
public class IterativeDoublingConverterTests
{
    private IterativeDoublingConverter _converter;

    [SetUp]
    public void Setup()
    {
        _converter = new IterativeDoublingConverter();
    }
